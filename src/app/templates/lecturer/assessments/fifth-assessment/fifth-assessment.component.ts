 ...
 // this.results.group_Id = Number(this.student.studGroup);
  ...
  if (this.optradio == '2'){
    for (let i = 0; i < this.students.length; i++){
      ...
      this._AssessmentService.submitResults(this.average4, this.assessment[0].assessment_Id, this.students[i].student_Id, this.student.studGroup,this.comment)
                              .subscribe((data) => {
    ...
    this._AssessmentService.submitIndResults(this.average4, this.assessment[0].assessment_Id, this.student.stud_ID, this.comment)
                          .subscribe((data) => {
